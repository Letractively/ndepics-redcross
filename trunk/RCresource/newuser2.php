...
$mail_to = $email;
	...
	$mail_message .= "Below you will find your username and temporary password information.  ";
...
//Send email and print out confirmation message
...
else { //mail message did not send
	print "<center>\n";
