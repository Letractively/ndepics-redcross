...
$in_table = $_GET['table'];
$good_tables = array("organization", "person", "detailed_resource");
// Make sure the web has access to that table.
if( in_array( $in_table, $good_tables ) ){
	$table = $in_table;
}
else{
	die( "ERROR: '$in_table' is not a valid csv output table!<br />\n" );
}
