...
//  Fall 2009
//
// resourcecityresults.php - the search results page for resource searches by city.
//
//
//****************************
?>
...
<html>
<head>
<title>Disaster Database - Resource by City Search Results</title>
...
$city = scrub_search($_SESSION['search_city']);
$zip = scrub_search($_SESSION['search_zip']);
...
if($city != ''){
	print "<h3><center>Searching for organizations in the city: \"".$city."\"</center></h3>";
	$matchterms = "city, county";
	
	$query .= " AND	MATCH(".$matchterms.") AGAINST('".$city."' IN BOOLEAN MODE )";
	
}

if($zip != ''){
	print "<h3><center>Searching for organizations in the ZIP code: ".$zip."</center></h3>";
	$matchterms = "zip";
	$query .= " AND MATCH(".$matchterms.") AGAINST('".$zip."' IN BOOLEAN MODE )";
}
