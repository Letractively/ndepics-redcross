...
//Pick up POSTed variables from addresource1.php
...
// Display variables for the user to verify
...
//Forward variables as hidden inputs
...
//Print information in table for clean formatting
print "<table>";
	print "<tr>";
...
//Forward sequence marker as a hidden input
print "<input type=hidden name='addresfromorg' value=\"".$addresfromorg."\">";
//If it is set, we need to keep these variables alive through hidden inputs
if($addresfromorg){
