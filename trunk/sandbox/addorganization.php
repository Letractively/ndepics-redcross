...
validator("Unit",$unit,"string","","","1");
validator("Your Initials",$updated_by,"alpha","2","10","1");
...
//Initials/Updator
validator("Your Initials",$updated_by,"string","2","10","1");
if($messages[$errCount]) {
  print $messages[$errCount]."<br />";
  $errCount++;
  print "<tr>\n";
  print "<td><b>Your Initials: </b></td>\n";
  print "<td><input name='updated_by' type='text' size='10' maxlength='10' align= 'left' value='".$updated_by."'></td>\n";
  print "</tr>\n";
} else {
