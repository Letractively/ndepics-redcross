...
// per_csv.php - script that prints full person dump and writes to CSV
//****************************
...
// Query database for all persons
...
if($file){
	print "Writing to person.csv.<br />\n";
} else {
	print "ERROR: Could not write to person.csv.<br />Please use the printout below:<br /><br />\n";
}
...
if(!fclose($outfile)) {
	print "ERROR: Could not close person.csv.<br />\n";	
} else {
	print "Finished writing to person.csv.<br />\n";
}

include("./../config/closedb.php"); //close database connection
//redirect to download
print "<meta http-equiv=\"Refresh\" content=\"0;url=./person.csv\" />";
?>
